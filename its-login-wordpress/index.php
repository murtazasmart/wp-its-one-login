<?php
/*
Plugin Name:  ITS OneLogin Auth for WordPress V2.2
...
function oneLoginDecryptData($cipherText) {
    ...
    $decodedResult = rtrim(mb_convert_encoding(
        openssl_decrypt(
            ($cipherText), 
            'AES-128-CBC', 
            substr($key, 0, 16), 
...
function is_its_authenticated() {
    ...
    return has_user_data('its_authenticated');
}
...
// === AUTH CALLBACK HANDLER (MINIMAL, v2.2.0) ===
/**
